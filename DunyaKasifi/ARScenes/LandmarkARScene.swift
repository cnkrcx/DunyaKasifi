...
class LandmarkARScene: UIViewController, ARSCNViewDelegate {
    ...
    let landmarks = ["EiffelTower", "StatueOfLiberty", "BigBen", "Colosseum", "GreatWall"]
    ...
    override func viewDidLoad() {
        ...
        addLandmarkModel(named: "EiffelTower")
        setupGestureRecognizers()
    }
    
    func addLandmarkModel(named modelName: String) {
    ...
    func addModelAtLocation(hitResult: ARHitTestResult) {
        guard let modelScene = SCNScene(named: "art.scnassets/StatueOfLiberty.scn") else { return }
        let modelNode = modelScene.rootNode
    ...
    func addInteractionForLandmarkModel() {
...
struct LandmarkARSceneView: View {
    var body: some View {
        LandmarkARSceneWrapper()
            .edgesIgnoringSafeArea(.all)
    }
}

struct LandmarkARSceneWrapper: UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> LandmarkARScene {
        return LandmarkARScene()
    }

    func updateUIViewController(_ uiViewController: LandmarkARScene, context: Context) {}
}

struct LandmarkARScene_Previews: PreviewProvider {
